...
export const uiLabels: Record<Locale, UiLabels> = {
  en: {
    ...
    assistantQuestions: [
      ...
      'Could Nam work remotely from Vietnam?',
      'Can Nam work in a hybrid role around Sindelfingen?',
  ...
  de: {
    ...
    assistantQuestions: [
      ...
      'Könnte Nam aus Vietnam remote arbeiten?',
      'Kann Nam in einer hybriden Stelle im Raum Sindelfingen arbeiten?',
  ...
  vi: {
    ...
    assistantQuestions: [
      ...
      'Nam có thể làm việc từ xa tại Việt Nam không?',
      'Nam có thể làm việc hybrid quanh Sindelfingen không?',
